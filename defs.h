...
// kalloc.c
char*           kalloc(void);
void            kfree_kalloc(char*);

void            kinit1(void*, void*);
void            kinit2(void*, void*);
void            kmem_init_kalloc (void);
...
//PAGEBREAK: 16
// for threading
// Threading (in thread.c or proc.c depending on where you implemented them)
...
void            barrier_init_impl(int);
int             barrier_check_impl(void);
