...
// Source - https://stackoverflow.com/questions/59985900/xv6-system-panic-when-attempt-to-read-big-file
// Posted by Z E Nir
...
bmap(struct inode *ip, uint bn)
{
  ...
  if(bn < NDINDIRECT){
    ...
    if((addr = a[bn%NINDIRECT]) == 0){
      ...
      log_write(bp);
      cprintf("Double-indirect block allocated: file block %d -> disk block %d\n", bn, addr);
    }
